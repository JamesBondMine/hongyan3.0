...
class SelectFriendWithGroupPage extends StatefulWidget {

  final ValueChanged<List<String>> onConfirm;
  
  const SelectFriendWithGroupPage({
    super.key,
    required this.onConfirm,
  });

  @override
  State<SelectFriendWithGroupPage> createState() => _SelectFriendWithGroupPageState();
}

class _SelectFriendWithGroupPageState extends State<SelectFriendWithGroupPage> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: '搜索好友',
          hintStyle: TextStyle(color: GbsColors.des9Color, fontSize: 14),
          prefixIcon: Icon(Icons.search, color: GbsColors.des9Color, size: 20),
          suffixIcon: _searchKeyword.isNotEmpty
              ? IconButton(
                  icon: Icon(Icons.clear, color: GbsColors.des9Color, size: 20),
                  onPressed: () {
  ...
  Widget _buildBottomButton() {
    ...
    return Container(
      ...
      text: '添加${selectedCount > 0 ? '($selectedCount)' : ''}')),
    );
