...
/// 会话搜索页面
class SearchMessageHistory extends StatefulWidget {
  ...
  @override
  State<SearchMessageHistory> createState() => _SearchMessageHistoryState();
}

class _SearchMessageHistoryState extends State<SearchMessageHistory> {
