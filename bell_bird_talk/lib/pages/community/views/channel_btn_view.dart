...
/// 通用按钮组件
/// 默认灰色不可点击，激活状态可以点击
class ChannelBtnView extends StatelessWidget {
  /// 按钮文本
  final String text;
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: enabled ? GbsColors.primaryColor : Color(0xffF4F4F4),
          foregroundColor: enabled ? txtColor : GbsColors.des6Color,
          disabledBackgroundColor: Color(0xffF4F4F4),
          disabledForegroundColor: GbsColors.des6Color,
