...
import 'package:bell_bird_talk/services/community_bridge.dart';
...
class IOSNativeService {
  ...
  final CommunityBridge community;

  IOSNativeService() 
      : community = CommunityBridge(
          bridge: const MethodChannel('com.bellbird.talk/method'),
        );
  ...
  // ======================== 社群管理 ========================
  // 已移至 CommunityBridge 类（lib/services/community_bridge.dart）
