...
GPBObjCClassDeclaration(GroupBrief);
...
typedef struct CSearchResult__storage_ {
  uint32_t _has_storage_[1];
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = CSearchResult_FieldNumber_MessagesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(CSearchResult__storage_, messagesArray),
      ...
      },
      {
        .name = "page",
        .dataTypeSpecific.clazz = GPBObjCClass(Page),
        .number = CSearchResult_FieldNumber_Page,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(CSearchResult__storage_, page),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        ...
        .number = CSearchResult_FieldNumber_ContactResultsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(CSearchResult__storage_, contactResultsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "groupResultsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(GroupBrief),
        .number = CSearchResult_FieldNumber_GroupResultsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(CSearchResult__storage_, groupResultsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        ...
        .number = CSearchResult_FieldNumber_MemberResultsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(CSearchResult__storage_, memberResultsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[CSearchResult class]
                                     rootClass:[ChatPbRoot class]
                                          file:ChatPbRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(CSearchResult__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
